                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="post" action="show" id="${rankInstance?.post?.id}">${rankInstance?.post?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:rankInstance, field:'score')}</td>
