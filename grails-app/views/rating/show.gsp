                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:ratingInstance, field:'score')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Post Id:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:ratingInstance, field:'postId')}</td>
